...
export const translations: Translations = {
  ...
  heroDescription: {
    id: "Solusi Point of Sales terbaik untuk UMKM. Kelola bisnis lebih mudah dengan fitur lengkap, pencatatan otomatis, dan laporan real-time untuk keputusan yang lebih cerdas.",
    en: "The best Point of Sales solution for small businesses! Simplify your operations with complete features, automated tracking, and real-time reports for smarter decisions.",
  },
  heroTryFree: {
    id: "Daftar Gratis",
