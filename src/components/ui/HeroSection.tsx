      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gray-800/50 rounded-full opacity-70 blur-xl -z-10"></div>
            <img 
              src="/lovable-uploads/d029158e-e30a-4faa-9dd6-6b648b5ee417.png" 
              alt="KOSTPOS Application"
              className="rounded-xl shadow-2xl border border-gray-800 w-full max-w-[120%] mx-auto"
            />
          </div>
        </div>
      </div>
